...
class AppColors {
  ...
  static const Color lightBackgroundPrimary = Color(
    0xFFFAF9F7,
  ); // Main app background
  ...
  static const Color lightTextTertiary = Color(
    0xFF8E8E8E,
  ); // Placeholders, non-critical info

  // Accent Colors
  static const Color lightAccentPrimary = Color(
    0xFF6B9080,
  ); // Main actions, links
  static const Color lightAccentPrimaryHover = Color(
    0xFF5A7A6B,
  ); // Hover/pressed states
  static const Color lightAccentSecondary = Color(
    0xFFD4A574,
  ); // Badges, special tags
  static const Color lightAccentTertiary = Color(
    0xFFA4B8C4,
  ); // Secondary elements
  ...
  static const Color lightBorderVisible = Color(
    0xFFD4CFC7,
  ); // Frames, delimitations
  ...
  // Accent Colors
  static const Color darkAccentPrimary = Color(
    0xFF83AB96,
  ); // Main actions, links
  static const Color darkAccentPrimaryHover = Color(
    0xFF9DBFAC,
  ); // Hover/pressed states
  static const Color darkAccentSecondary = Color(
    0xFFD9B388,
  ); // Badges, special tags
  static const Color darkAccentTertiary = Color(
    0xFF99B4C9,
  ); // Secondary elements
  ...
  static const Color darkBorderVisible = Color(
    0xFF4A4A4D,
  ); // Frames, delimitations
}
